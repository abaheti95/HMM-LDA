...
public:
	...
	HiddenMarkovModelLatentDirichletAllocation(int vocab, int topcis, int classes, int start_word_id, int end_word_id, double n_alpha, double n_beta, double n_gamma, double n_delta, string save_directory);
